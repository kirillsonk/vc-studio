...
export const DEMO_CASE: DemoCase = {
  ...
  lead: 'Не клиентский кейс, а рабочий пример: тридцать секунд, canvas, лидерборд и промокод после прохождения. В нее можно сыграть выше. Показываем срок, бюджет и фактический AI-расход как в настоящем отчете',
  days: 9,
  budget: 184000,
  aiCost: 18320,
  tokens: 8421388,
