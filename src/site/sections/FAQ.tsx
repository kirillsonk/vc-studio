...
const QA: Array<[question: string, answer: string]> = [
  ...
  ['Кто отвечает, если AI ошибётся?', 'Мы. Клиент работает со студией, а не с моделью. Проверка кода, тестирование, интеграции и запуск находятся на нашей стороне.'],
  ['Код останется у нас?', 'Да. После запуска проект, исходный код и необходимая документация передаются клиенту согласно договору.'],
  ['Можно передать вам дизайн от другого агентства?', 'Да. Можем подключиться только как production-партнёр: взять готовый дизайн и собрать frontend, backend, интерактив или 3D.'],
];
