...
export function Select({ error, disabled, options = [], placeholder, style, ...rest }: SelectProps) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      <select
        ...
        style={{ ...inputBox(focus, error, disabled), height: 'var(--input-h)', appearance: 'none', paddingRight: 44, cursor: disabled ? 'not-allowed' : 'pointer', ...style }}
        {...rest}
      >
